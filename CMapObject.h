...
class Wearable {
	virtual void onEquip ( CCreature * ) =0;
	virtual void onUnequip ( CCreature * ) =0;
};

class Usable {
	virtual void onUse ( CCreature * ) =0;
};
...
public:
	...
	virtual void setMap ( CMap *map ) =0;
...
class CMapObject : public CGameObject,public CAnimatedObject {
