...
cmake -B./cmake-build-debug -H. -DCMAKE_BUILD_TYPE=Debug -DCMAKE_CXX_COMPILER=%CXX% -DCMAKE_C_COMPILER=%CC% -DCMAKE_MAKE_PROGRAM=windows-tools/mingw/mingw64/bin/mingw32-make.exe -G "MinGW Makefiles"
cmake -B./cmake-build-release -H. -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_COMPILER=%CXX% -DCMAKE_C_COMPILER=%CC% -DCMAKE_MAKE_PROGRAM=windows-tools/mingw/mingw64/bin/mingw32-make.exe -G "MinGW Makefiles"