...
class CController : public CGameObject {
  ...
  public:
    ...
    virtual void onStepCommitted(std::shared_ptr<CCreature> creature, const Coords &coords);

    virtual void interrupt(std::shared_ptr<CCreature> creature);

    virtual void onTurnEnded(std::shared_ptr<CCreature> creature);
};
...
class CPlayerController : public CController {
  ...
  public:
    ...
    void onStepCommitted(std::shared_ptr<CCreature> creature, const Coords &coords) override;
...
class CTargetController : public CController {
    V_META(CTargetController, CController, V_PROPERTY(CTargetController, std::string, target, getTarget, setTarget))
  public:
    CTargetController();
...
class CRangeController : public CController {
    V_META(CRangeController, CController, V_PROPERTY(CRangeController, std::string, target, getTarget, setTarget),
